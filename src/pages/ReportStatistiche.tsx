      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card title="Tempo di Sosta Medio (Turnaround)" accent="orange">
          <div className="text-center py-4 font-mono">
            <div className="text-5xl font-bold text-cyber-orange">
              {avgTurnaround} <span className="text-xl">min</span>
            </div>
            <div className="text-[10px] text-cyber-text-muted mt-2 uppercase tracking-wider">
        ...
        <Card title="Saturazione Istantanea Baie" accent="yellow">
          <div className="text-center py-4 font-mono">
            <div className="text-5xl font-bold text-cyber-yellow">
              {utilizationRate}%
            </div>
            <div className="text-[10px] text-cyber-text-muted mt-2 uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6 font-mono text-sm py-4">
            <div className="space-y-2">
              <div className="flex justify-between text-xs text-cyber-text-muted">
                ...
                <span className="font-bold text-cyber-text">{scheduledCount} / {totalBookingsCount}</span>
              </div>
              <div className="w-full h-3 bg-cyber-bg border border-cyber-border">
                <div
                  className="h-full bg-cyber-border"
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs text-cyber-text-muted">
                ...
                <span className="font-bold text-cyber-orange">{activeYardCount} / {totalBookingsCount}</span>
              </div>
              <div className="w-full h-3 bg-cyber-bg border border-cyber-border">
                <div
                  className="h-full bg-cyber-orange animate-pulse-glow"
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs text-cyber-text-muted">
                ...
                <span className="font-bold text-cyber-green">{completedCount} / {totalBookingsCount}</span>
              </div>
              <div className="w-full h-3 bg-cyber-bg border border-cyber-border">
                <div
            ...
            <div className="border-t border-cyber-border pt-4 text-xs text-cyber-text-muted space-y-1">
              <div>// STATO TOTALE PRENOTAZIONI GIORNALIERE: {totalBookingsCount} TRANSAZIONI</div>
              {completedCount === 0 && (
                <div className="text-cyber-yellow text-[10px] uppercase font-bold mt-1">
        ...
        <Card title="Tempi Medi Turnaround per Vettore (Minuti)">
          <div className="space-y-4 font-mono py-2">
              ...
              return (
                <div key={carrier.id} className="space-y-1">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-cyber-yellow">{carrierAvg} min</span>
                  </div>
                  <div className="w-full h-4 bg-cyber-bg border border-cyber-border flex items-center">
                    <div
                      className="h-full bg-cyber-yellow border-r-2 border-r-cyber-orange"
            ...
            <div className="text-[10px] text-cyber-text-muted uppercase mt-4">
