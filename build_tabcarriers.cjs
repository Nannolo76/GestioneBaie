...
const tabCarriersHeader = `import React from 'react';
...
fs.writeFileSync('src/components/admin/TabCarriers.tsx', tabCarriersHeader);
console.log('TabCarriers.tsx assembled successfully!');
